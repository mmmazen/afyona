...
OWNER_NAME = getenv("OWNER_NAME", "افـ ـ ـيـ ـ ـونـ ـ ﭑ ﺳ ـ ﺂ فـ ـ ـل الـ ـ ـمـ ـشـ ـ ـراحـ ـ ـه "𝙏")
OWNER_USERNAME = getenv("OWNER_USERNAME", "Xx_A_f_y_o_n_a_xX")
ALIVE_NAME = getenv("ALIVE_NAME", "افـ ـ ـيـ ـ ـونـ ـ ﭑ ﺳ ـ ﺂ فـ ـ ـل الـ ـ ـمـ ـشـ ـ ـراحـ ـ ـه "𝙏")
